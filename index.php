...
<div id="page_wrapper">
	...
	<header class="main_nav">
		<div class="container">
			<nav id="navbar-example2" class="navbar navbar-expand-lg navbar-light w-100"> 
				<a class="navbar-brand" href="#top">Mirnawati</a>
	...
	<!--	Start Main Banner 
	==================================================-->
	<section id="main_banner" class=" banner_water_effect background-mirna overlay_one">
		<div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-md-12 col-lg-12 home-content text-left">
                    <div class="mainbanner_content">
                        <span class="pb_5 banner_title color_white">Hello I'am Mirnawati</span>  
                        <h1 class="cd-headline clip is-full-width text-uppercase">
                            ...
                            <span class="cd-words-wrapper color_default">
                                <b class="is-visible">Database Administrator.</b>
                                <b>Data analyst.</b>
                                <b>Freelancer.</b>
                            </span>
                        </h1>
                        <p class="color_white mb_30">As a Database Administrator (DBA), my goal is to provide maximum contribution in ensuring data integrity and database system availability, as well as collaborating effectively with the technical team to achieve given business objectives.</p>
                        <a class="btn btn-default" href="https://drive.google.com/file/d/1Jpdo6RyoboJRGJf-aoniKSqiRfAax18D/view">Download CV</a>
                    </div>
                </div>          
            </div>
        </div>
				...
				<div class="row">
					<div class="col-md-7 col-lg-7">
						<div class="myself color_secondery wow animated fadeInLeft">
							<p>"I am a Database Administrator with a primary focus on designing, managing, and optimizing database systems. With a strong background and commitment to data security and availability, I have successfully managed complex database environments, ensuring smooth operational performance."</p>
							
							<p>During my college year, I actively participated in external and internal organizations which honed my soft skills such as problem-solving and working in a team..</p>
						</div>
						<div class="personal_info">
							<div class="row">
								...
								<div class="col-md-12 col-lg-6">
									<ul>
										<li><span class="color_secondery">Date of Birth :</span> 20 Agustus 2004</li>
										<li><span class="color_secondery">Blood Group :</span> A+</li>
										<li><span class="color_secondery">Address :</span> Lebak-Banten, Indonesia.</li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div class="col-md-5 col-lg-5">
						<div class="profile_img personal_video wow animated fadeInRight">
							<img src="images/about/mirna.png" alt="image">
							<div class="iconround"><a class="video-popup" href="https://youtu.be/-uQKvErHo98?si=JPz9aTRnlhQbrk-Q" title="video popup">
				...
				<div class="row">
					<div class="col-md-12 col-lg-6">
						<div class="about_myskill color_secondery wow animated slideInLeft">
							<h2 class="color_primary">Some talk about skill</h2>
							<p class="pt_15">"I have expertise in designing efficient database structures and ensuring data integrity through the precise application of normalization. In daily administration, I am skilled in executing necessary processes such as backup, restore, and maintenance, while continually monitoring database performance to proactively enhance efficiency. Data security is my primary focus, where I establish stringent security policies and actively engage in tracking as well as mitigating potential threats."</p>
							<p class="pt_15"></p>
						</div>
					</div>
					<div class="col-md-12 col-lg-6">
						<div class="skill-progress wow animated slideInRight">
		                    <div class="prgs-bar fact-counter"> <span>Mysql</span>
		                        <div class="progress count wow" data-wow-duration="0ms">
		                            <div class="skill-percent"><span class="count-num" data-speed="3000" data-stop="90">75</span>%</div>
		                            <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemax="100"> </div>
								</div>
							</div>
		                    <div class="prgs-bar fact-counter"> <span>Database design</span>
		                        <div class="progress count wow" data-wow-duration="0ms">
		                            <div class="skill-percent"><span class="count-num" data-speed="3000" data-stop="95">75</span>%</div>
		                            <div class="progress-bar" role="progressbar" aria-valuenow="95" aria-valuemax="100"> </div>
								</div>
							</div>
		                    <div class="prgs-bar fact-counter"> <span>Database administration</span>
		                        <div class="progress count wow" data-wow-duration="0ms">
		                            <div class="skill-percent"><span class="count-num" data-speed="3000" data-stop="85">50</span>%</div>
		                    ...
		                    <div class="prgs-bar fact-counter"> <span>PHP</span>
		                        <div class="progress count wow" data-wow-duration="0ms">
		                            <div class="skill-percent"><span class="count-num" data-speed="3000" data-stop="90">10</span>%</div>
		                            <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemax="100"> </div>
								</div>
							</div>
		                    <div class="prgs-bar fact-counter"> <span>Analysis data</span>
		                        <div class="progress count wow" data-wow-duration="0ms">
		                            <div class="skill-percent"><span class="count-num" data-speed="3000" data-stop="90">50</span>%</div>
		                            <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemax="100"> </div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-4 col-lg-4">
							    <div class="counter count wow text-center" data-wow-duration="300ms">
					            	...
					            	<div class="counting_digit color_default mt_15"> <h2 class="count-num" data-speed="3000" data-stop="0">0</h2><span>+</span>
					            	</div>
...
<section id="timeline" class="timeline_area section_padding_130">
	...
	<section id="portfolio" class="py_80 bg_secondery full_row">
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-lg-12">
					<div class="section_title_1 text-center mx-auto pb_60 wow animated slideInUp">
	                    <h2 class="title text-uppercase"><span class="line_double mx-auto color_default">portfolio</span>Projects</h2>
	                    <span class="sub_title">"I worked on a project to create a financial and student database as an assignment for the Database Management course. The main objectives were to enhance performance, focus, analysis, and research. The project aimed to design and implement a comprehensive database that incorporates financial data and student records. This undertaking not only contributed to my understanding of database management principles but also honed my skills in performance optimization, focused analysis, and effective research methodologies."</span>
	                </div>
				</div>
				<div class="col-md-12 col-lg-12">
							...
							<div class="portfolio-items">
								<div class="row">
									...
									<div class="column mix mix_all graphic wordpress branding mb_30 col-md-4 col-lg-4">
										<div class="default-portfolio-item">
											<a href="images/portfolio/WhatsApp Image 2023-12-11 at 12.12.41.jpeg" data-fancybox="gallery">
												<img src="images/portfolio/WhatsApp Image 2023-12-11 at 12.12.41.jpeg" alt="image" />
												<div class="overlay-box">
													<span><i class="fa fa-eye" aria-hidden="true"></i></span>
													<div class="tag">
														<ul>
		    					...
		    					<ul>
		    						...
		    						<li>
		    							<div class="contact_text">
		    								...
		    								<span class="color_secondery">Lebak-Banten, Indonesia</span>
		    							</div>
		    						</li>
		    						<li>
		    							<div class="contact_text">
		    								<h6 class="font-weight-bold color_primary">Website</h6>
		    								<span class="color_secondery">mirnawati.my.id</span>
		    							</div>
		    						</li>
		    					</ul>
		    				</div>
	...
	<footer class="p_20 color_primary bg_secondery text-center full_row">
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-lg-12">
					<div class="copyright"><p><a href="https://www.templateshub.net" target="_blank"></a></p></div>
				</div>
			</div>
		</div>
	</footer>
